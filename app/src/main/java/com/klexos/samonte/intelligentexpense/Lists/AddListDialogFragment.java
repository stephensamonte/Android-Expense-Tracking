package com.klexos.samonte.intelligentexpense.Lists;
...
public class AddListDialogFragment extends DialogFragment {
    ...
    public void addShoppingList() {
        ...
        Firebase ref = new Firebase(Constants.FIREBASE_URL); // This is just my firebase Url
        // Get the string that the user entered into the EditText
        String userEnteredName = mEditTextListName.getText().toString();
        // go to the "listName" child node of hte root node.
        // This will create the node for you if it doesn't already exist.
        // Then using the setValue menu it will set value the node to the user
        ...
        // This will create the node for you if it doesn't
//        ref.child("listName").setValue(userEnteredName); // This is a key value pair that writes to my database
        ref.child("activeList").setValue(currentList); // activeList is the root node
    }
}