...
import com.klexos.samonte.intelligentexpense.Lists.AddListDialogFragment;
...
import com.klexos.samonte.intelligentexpense.SelectDisplayFragment.ListsDisplayFragment;

public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener,
        GeneralDisplayFragment.OnListFragmentInteractionListener,
        ListsDisplayFragment.OnListFragmentInteractionListener {
...
//        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_overview) {
            ...
            DisplayNumber = 4;
//            OpenDisplayActivityFragment(DisplayNumber); // IThis fragment has its own java
